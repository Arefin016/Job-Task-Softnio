...
const Testimonial = ({ title, dis, videoData = [] }) => {
  ...
  const prev = () =>
    setCurr((curr) => (curr === 0 ? videoData.length - 1 : curr - 1))
  const next = () =>
    setCurr((curr) => (curr === videoData.length - 1 ? 0 : curr + 1))
            ...
            {videoData.map((item, index) => (
              <div
                ...
                className={`flex-shrink-0 ${
                  windowWidth <= 400 ? "w-full" : "max-w-[1320px]"
                }`}
              >
