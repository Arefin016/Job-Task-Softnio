  ...
  return (
    <div className="flex flex-col-reverse md:flex-row gap-0  max-w-full mt-16">
      <div className="bg-[#FEBF00] min-w-[300px] min-h-[300px] relative p-4 flex flex-col items-center pb-16 md:pb-0 md:w-1/2">
        <p className="text-center mb-4 p-4 mt-12 text-[20px]">
          <span className="text-5xl">“</span>
          You can't go wrong with Chicken Mandi, I had it twice. The chicken was
          cooked perfectly, juicy & soft (usually mandi chicken is a bit dry). I
        ...
        <img
          src="aaaaaaa.png"
          alt=""
          className="absolute left-0 bottom-0 md:bottom-12 "
        />
