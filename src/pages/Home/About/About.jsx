    ...
    <div className=" mt-8 md:mt-44 relative">
        ...
        <div className="w-full md:w-[50%] mt-8 md:mt-0">
          <div className="flex gap-6">
            ...
            <button
              ...
              className={`bg-[${experience}] px-4 py-1 `}
            >
              Experience
            </button>
            <button
          ...
          {aboutcontent && (
            <div>
              <h1 className=" text-[20px] md:text-[35px] font-bold uppercase leading-[20px] md:leading-[35px] mt-8">
              ...
              <div className="flex gap-12  items-center">
                <button className=" mt-12 uppercase bg-[#FEBF00] px-[14px] md:px-[24px] py-[8px] md:py-[10px] text-[#0A1425] text-[16px] font-bold">
                  About More
                </button>
                <p className="flex gap-2 items-center mt-8">
                  <LuPhoneCall color="red" /> +88 3426 739 485
                </p>
              </div>
            </div>
          )}
          {experiencecontent && (
            <div>
              <h1 className=" text-[20px] md:text-[35px] font-bold uppercase leading-[20px] md:leading-[35px] mt-8">
                Phosfluorescently leverage <br /> other's integrated alignments.
              </h1>
              <p className="mt-8">
                Phosfluorescently redefine cross-platform opportunities through
                efficient markets. Efficiently parallel task leveraged testing
                procedures through leveraged mindshare. Credibly supply resource
                sucking relationships via virtual customer service. Credibly
                communicate ethical niche markets with optimal vortals. Quickly
                scale dynamic schemas for equity invested information.
              </p>
              <div className="flex gap-12  items-center">
                <button className=" mt-12 uppercase bg-[#FEBF00] px-[14px] md:px-[24px] py-[8px] md:py-[10px] text-[#0A1425] text-[16px] font-bold">
                  About More
          ...
          {contactcontent && (
            <div>
              <h1 className=" text-[20px] md:text-[35px] font-bold uppercase leading-[20px] md:leading-[35px] mt-8">
                Quickly disseminate <br /> go forward metrics with.
              </h1>
              <p className="mt-8">
                Synergistically simplify flexible content and premier internal
                or "organic" sources. Continually extend an expanded array of
                alignments after enterprise communities. Rapidiously generate
                distributed models and sustainable resources. Completely
                transition fully researched channels for dynamic portals.
                Distinctively syndicate 24/365 niche markets via go forward.
              </p>
              <div className="flex gap-12  items-center">
                <button className=" mt-12 uppercase bg-[#FEBF00] px-[14px] md:px-[24px] py-[8px] md:py-[10px] text-[#0A1425] text-[16px] font-bold">
                  About More
      ...
      <div className="max-w-[1320px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-12">
        <div className="flex items-center mt-8 md:mt-0">
          <div>
            <img src="a.png" className="max-w-[90px]" alt="" />
          </div>
          <div>
            <h1 className="text-[30px] text-[#0A1425] uppercase  font-bold">
              fast delivery
            </h1>
        ...
        <div className="flex items-center mt-8 md:mt-0">
          <div>
            <img src="b.png" className="max-w-[90px]" alt="" />
          </div>
          <div>
            <h1 className="text-[30px] text-[#0A1425] uppercase  font-bold">
              absolute dining
        ...
        <div className="flex items-center mt-8 md:mt-0">
          <div>
            <img src="c.png" className="max-w-[90px]" alt="" />
          </div>
          <div>
            <h1 className="text-[30px] text-[#0A1425] uppercase  font-bold">
              pickup delivery
