      ...
      <div className="max-w-[1320px] mx-auto px-4 md:px-0 py-4 md:py-8 z-50">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:block ml-8">
            <a
              href="#booktable"
              className="uppercase bg-[#FEBF00] px-6 py-2 text-[#0A1425] font-bold text-sm lg:text-base"
            >
              Book a table
            </a>
          </div>
        ...
        {isOpen && (
          <div className="lg:hidden absolute inset-x-0 top-full z-20 w-full bg-red-800 dark:bg-gray-800 px-6 py-4">
            ...
            <div className="mt-4">
              <a
                href="#booktable"
                className="uppercase bg-[#FEBF00] px-6 py-2 text-[#0A1425] font-bold text-sm"
              >
                Book a table
              </a>
            </div>
